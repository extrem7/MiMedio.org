...
<div class="row channel-others-users">
    <div class="col-12 col-lg-8">
        <div class="d-flex align-items-center flex-column flex-lg-row">
            <a href="{{$user->link}}"><img src="{{$user->getLogo()}}" alt="{{$user->name}}"
                                           class="mr-4 logo-channel"></a>
    ...
    <div class="col-12 col-lg-4">
        <div class="box-shadow-content channel-info-box mt-4 mt-lg-0 {{$user->id===auth()->id()?'two-column':''}}">
            <div class="item">
            ...
            @if(!is_current_user($user))
                <follow-button :user_id="{{$user->id}}" :initial_following="{{is_following($user)?'true':'false'}}">
                </follow-button>
            @endif
        </div>
    </div>
